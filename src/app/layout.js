  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="google-site-verification" content="gubtxIvp2Uc-xqowt9NifxvgrCFdzbj8kDcOYw-TVKU" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "potentialAction": {
                "@type": "SearchAction",
                "target": "https://angelex.co/search?q={search_term_string}",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@id": "https://angelex.co/#organization",
              "name": "AngelX",
              "url": "https://angelex.co/",
              "logo": "https://angelex.co/images/logo-icon.png",
